...
|-------|--------|------|---------|-------|-------|---------|
| 1 (ปกติ) |8 ครั้ง | 6 ครั้ง| 15 ครั้ง  | 2 ครั้ง  |31 ข้อความ |ทุก Queue ทำงานปกติ Processor ได้รับข้อมูลครบทั้ง 4 ชนิด|
| 2 (ไม่มี Sensor) | - | 7 ครั้ง| 16 ครั้ง| 3 ครั้ง| 26 ข้อความ|ไม่มีข้อมูล Sensor เข้ามา ค่าการนับ sensor_count ไม่เพิ่ม |
| 3 (Network เร็ว) |7 ครั้ง |5 ครั้ง |40 ครั้ง (ถี่มาก) |2 ครั้ง |54 ข้อความ |Network ส่งข้อมูลเข้ามาเกือบทุก 0.5 วินาที Processor ทำงานถี่ขึ้น โหลด CPU สูง แต่ระบบยังเสถียร |
