...
|-------|-----------|-----------|----------|----------|---------|------------|
| 1 | 3 | 2 | | | | | 2             35         32         3          91.4%
| 2 | 4 | 2 | | | | | 2             48         40         8          83.3%
| 3 | 3 | 1 | | | | | 1             42         26         16         61.9%

### คำถามสำหรับการทดลอง
1. ในทดลองที่ 2 เกิดอะไรขึ้นกับ Queue?
    คิวมีแนวโน้มเต็มเร็ว เนื่องจากจำนวนผู้ผลิตมากขึ้น (4 คน) ทำให้มีงานเข้าคิวมากกว่าที่ผู้บริโภค 2 คนจะดึงออกได้ทัน

2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
    ระบบเข้าสู่ภาวะคอขวด (Queue Saturation) ผู้บริโภคเพียงคนเดียวไม่สามารถตามการผลิตทันทำให้สินค้าค้างคิวจำนวนมากและเกิดการ Drop อย่างต่อเนื่อง

3. Load Balancer แจ้งเตือนเมื่อไหร่?
    เมื่อจำนวนข้อความใน Queue เกิน 8 รายการจาก 10 (ตั้งค่าในโค้ด MAX_QUEUE_SIZE = 8)
    ระบบจะแสดงข้อความ “⚠️ HIGH LOAD DETECTED!” และแนะนำให้เพิ่ม consumer หรือปรับ processing time
