...
1. เมื่อ Queue เต็ม การเรียก `xQueueSend` จะเกิดอะไรขึ้น?
    ข้อความจะไม่ถูกส่งจนกว่าจะมีช่องว่างใน Queue หรือหมดเวลา timeout

2. เมื่อ Queue ว่าง การเรียก `xQueueReceive` จะเกิดอะไรขึ้น?
    Task จะหยุดรอจนกว่าจะมีข้อมูลส่งเข้ามาหรือหมดเวลา 5 วินาที

3. ทำไม LED จึงกะพริบตามการส่งและรับข้อความ?
    LED ใช้แสดง “กิจกรรม” ของแต่ละ Task
🔹 LED_SENDER → แสดงการส่งข้อมูล
🔹 LED_RECEIVER → แสดงการรับข้อมูล
