...
|-------|-----------|-----------|--------------|----------|---------------------|
| 1 (3R, 5P) | 3 | 5 | ~80–90%| 500–1500| ปานกลาง|
| 2 (5R, 5P) | 5 | 5 | ≈ 100%| ต่ำกว่า 500| สูงสุด|
| 3 (3R, 8P) | 3 | 8 | 60–70%| 1500–3000| สูงมาก (overload)|

### คำถามสำหรับการทดลอง
1. เมื่อ Producers มากกว่า Resources จะเกิดอะไรขึ้น?
    ระบบยังทำงานถูกต้อง แต่มีคอขวด (Resource Contention)
2. Load Generator มีผลต่อ Success Rate อย่างไร?
    Load Generator ใช้ทดสอบความทนทานของระบบ โดยทำให้เห็นพฤติกรรม “การแย่งใช้ทรัพยากร” ในสถานการณ์โหลดสูง

3. Counting Semaphore จัดการ Resource Pool อย่างไร?
    Counting Semaphore คือกลไกหลักในการ จัดการทรัพยากรจำกัดหลายหน่วยอย่างปลอดภัย (เช่นเครื่องจักร, buffer slot, I/O channel)
